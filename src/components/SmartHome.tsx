...
// 2. 定义 Device 类型 - 使 type 成为必填项
type Device = {
  name: string;
  icon: any;
  status: boolean;
  type: DeviceType; // 新增type类型
};
...
const SmartHome: React.FC = () => {
  ...
  // 3. 更新设备状态定义，确保所有设备都有 type 值
  const [devices, setDevices] = useState<Device[]>([
    { name: "智能空调", icon: faSnowflake, status: true, type: "default" },
    { name: "客厅灯光", icon: faLightbulb, status: false, type: "chosen" },
    { name: "智能窗帘", icon: faWind, status: true, type: "default" },
    { name: "安防系统", icon: faShieldAlt, status: true, type: "default" },
    { name: "新风系统", icon: faWind, status: false, type: "default" },
    { name: "地暖控制", icon: faTemperatureHigh, status: true, type: "default" },
  ]);
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <DraggableDevices
              ...
              onDevicesOrderChange={handleDevicesOrderChange}
            />
          </div>
